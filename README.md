...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/vpl-gpu-rt-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/vpl-gpu-rt-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install vpl-gpu-rt
```
...
It is possible to list all of the versions of `vpl-gpu-rt` available on your platform:
...
```
pixi search vpl-gpu-rt --channel conda-forge
```
